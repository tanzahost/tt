...
<head>
    ...
    <noscript><link rel="stylesheet" href="<?php echo e(asset('home/assets/css/style.css')); ?>"></noscript>

    <!-- Additional CSS files -->
    <link rel="stylesheet" href="<?php echo e(asset('home/core/extensions/ClientNotifications/assets/css/client-notifications.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('home/assets/css/fontawesome-all.min.css')); ?>">
    <!-- Google tag (gtag.js) -->
...
<body class="site ">
    ...
    <script type="text/javascript" src="<?php echo e(asset('home/assets/js/tp.widget.bootstrap.min.js')); ?>" defer>
    </script>
    <!--<?php echo $__env->make('templates.basic.partials.offer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>-->

    <?php echo $__env->yieldContent('main'); ?>


    <script src="<?php echo e(asset('home/assets/js/main.js')); ?>" type="text/javascript" defer></script>

    <script src="<?php echo e(asset('home/core/extensions/ClientNotifications/assets/js/client-notifications.js')); ?>" defer></script>
...
<?php /**PATH C:\Users\Almir Frances\Downloads\tanzahost.in\resources\views/templates/basic/layouts/main.blade.php ENDPATH**/ ?>
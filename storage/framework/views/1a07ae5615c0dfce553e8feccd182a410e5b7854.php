<?php if($seo): ?>
    ...
    <!-- Standard favicon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(getImage(getFilePath('logoIcon') .'/favicon.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(getImage(getFilePath('logoIcon') .'/favicon.png')); ?>">
    <link rel="icon" type="image/png" sizes="48x48" href="<?php echo e(getImage(getFilePath('logoIcon') .'/favicon.png')); ?>">

    <!-- Microsoft Tiles -->
    <meta name="msapplication-TileImage" content="<?php echo e(getImage(getFilePath('logoIcon') .'/favicon.png')); ?>">
    <meta name="msapplication-TileColor" content="#ffffff">

    <!-- Android / Chrome, Manifest -->
    
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e(getImage(getFilePath('logoIcon') .'/favicon.png')); ?>">
    <link rel="icon" type="image/png" sizes="512x512" href="<?php echo e(getImage(getFilePath('logoIcon') .'/favicon.png')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\Almir Frances\Downloads\tanzahost.in\resources\views/partials/seo.blade.php ENDPATH**/ ?>
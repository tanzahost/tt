<section class="section">
    <span class="anchor-target" id="need-even-more-reasons-to-choose-Tanzahost?"></span>
    <div class="container">
        <h2 class="section__title">
            Still not convinced? Here are some more reasons to choose Tanzahost
        </h2>
        <p class="section__subtitle p-1">
            We provide you with a FREE domain name and TOP-NOTCH hosting service, as well as exceptional customer support. Additionally, every hosting plan we offer comes with a money-back guarantee and an uptime guarantee.
        </p>
                                ...
                                <svg width="88" height="88" viewBox="0 0 88 88" fill="none"
                                    ...
                                    <g clip-path="url(#mback2-clip0)">
                                        ...
                                        <path
                                            ...
                                            fill="white" />
                                        <path d="M60 37V45H68" stroke="#CC2628" stroke-width="4"
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="feature">
                        <div class="feature__body ">
                                ...
                                <svg width="88" height="88" viewBox="0 0 88 88" fill="none"
                                    ...
                                    <g clip-path="url(#onec8-clip0)">
                                        <path d="M53 21H63" stroke="url(#onec8-paint0_linear)" stroke-width="4"
                                            stroke-miterlimit="10" stroke-linecap="round" />
                                        <path d="M20 21H30" stroke="#35226F" stroke-width="4"
                                            stroke-miterlimit="10" stroke-linecap="round" />
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient id="onec8-paint1_linear" x1="52.375" y1="14" x2="52.375"
                                            y2="6" gradientUnits="userSpaceOnUse">
                                            <stop offset="1.81145e-07" stop-color="#2090F8" />
                                            <stop offset="1" stop-color="#336BFD" />
                                        </linearGradient>
                                        <linearGradient id="onec8-paint2_linear" x1="29.375" y1="14" x2="29.375"
                                            y2="6" gradientUnits="userSpaceOnUse">
                                            <stop offset="1.81145e-07" stop-color="#2090F8" />
                                            <stop offset="1" stop-color="#336BFD" />
                                        </linearGradient>
                                        ...
                                        <linearGradient id="onec8-paint4_linear" x1="50.2547" y1="88.4"
                                            x2="50.2547" y2="74" gradientUnits="userSpaceOnUse">
                                            <stop offset="1.81145e-07" stop-color="#2090F8" />
                                            <stop offset="1" stop-color="#336BFD" />
                                        </linearGradient>
                                        ...
                                        <linearGradient id="onec8-paint6_linear" x1="55.1703" y1="52.2"
                                            x2="55.1703" y2="35.5" gradientUnits="userSpaceOnUse">
                                            <stop offset="1.81145e-07" stop-color="#2090F8" />
                                            <stop offset="1" stop-color="#336BFD" />
                                        </linearGradient>
                            ...
                            <p class="feature__desc">
                                Web hosting should be easy to use. Log in to your account, and you’ll see just how
                                easy it is to get started with many cPanel tools just a click away.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="feature">
                        <div class="feature__body ">
                                ...
                                <svg width="88" height="88" viewBox="0 0 88 88" fill="none"
                                    ...
                                    <g clip-path="url(#sde8-clip0)">
                                        <path
                                            ...
                                            fill="url(#sde8-paint0_linear)" />
                                        <path
                                            d="M44 86C20.804 86 2 67.196 2 44C2 20.804 20.804 2 44 2C67.196 2 86 20.804 86 44C86 54.757 81.956 64.5694 75.3055 72"
                                            stroke="#CC2628" stroke-width="4" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M74 62V73H84" stroke="#CC2628" stroke-width="4"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="url(#sde8-paint1_linear)" />
                                        <path d="M36 47H51" stroke="#334766" stroke-width="2"
                                            stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M36 51H51" stroke="#334766" stroke-width="2"
                                            stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M36 55H51" stroke="#334766" stroke-width="2"
                                            stroke-miterlimit="10" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </g>
                                    <defs>
                                        <linearGradient id="sde8-paint0_linear" x1="3.27592" y1="23.0988"
                                            x2="84.4102" y2="23.0988" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#FDD0D0" />
                                            <stop offset="1" stop-color="#FDD0D0" stop-opacity="0.4" />
                                        </linearGradient>
                                        <linearGradient id="sde8-paint1_linear" x1="43.9899" y1="9.9382"
                                            x2="43.9899" y2="44" gradientUnits="userSpaceOnUse">
                                            <stop offset="0.0103002" stop-color="#5A3BC5" />
                                            <stop offset="0.9927" stop-color="#9C74F7" />
                                        </linearGradient>
                            ...
                            <p class="feature__desc">
                                Uptime is a lot better than downtime. That’s why you’ll never have to worry about
                                your website going down again with our 99.99% uptime guarantee.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="feature__icon">
                                <svg width="88" height="88" viewBox="0 0 88 88" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#F6DACD" stroke-width="8" stroke-miterlimit="10"
                                        stroke-linecap="round" />
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient id="freesslo-1_linear" x1="1.31671e-07" y1="47.8026"
                                            x2="60" y2="47.8026" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#FDC2A6" />
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="feature">
                        <div class="feature__body ">
                            <div class="feature__icon">
                                <svg width="88" height="88" viewBox="0 0 88 88" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="white" />
                                    <path d="M26 26H24V51H26V26Z" fill="#CC2628" />
                                    <defs>
                                        <linearGradient id="fdd8-paint0_linear" x1="52.7982" y1="6.99879"
                                            x2="52.7982" y2="59.0788" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#DDD8EC" />
                                            <stop offset="1" stop-color="#F2F0F8" />
                                        </linearGradient>
                                        <linearGradient id="fdd8-paint1_linear" x1="-4.82851e-07" y1="38.5628"
                                            x2="88" y2="38.5628" gradientUnits="userSpaceOnUse">
                                            <stop offset="0.0103002" stop-color="#5A3BC5" />
                                            <stop offset="0.9927" stop-color="#9C74F7" />
                                        </linearGradient>
                                    </defs>
                            ...
                            <p class="feature__desc">
                                Get your first year of domain registration on us when you choose our annual hosting
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="feature">
                        <div class="feature__body ">
                            <div class="feature__icon">
                                <svg width="88" height="88" viewBox="0 0 88 88" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke-linecap="round" />
                                    <defs>
                                        <linearGradient id="rcl8-paint0_linear" x1="41.0141" y1="0" x2="41.0141"
                                            y2="88" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#C7E8DF" />
                                            <stop offset="1" stop-color="#E0F4EF" />
                                        </linearGradient>
                                        <linearGradient id="rcl8-paint1_linear" x1="4.88098" y1="24.7269"
                                            x2="77.0001" y2="24.7269" gradientUnits="userSpaceOnUse">
                            ...
                            <p class="feature__desc">
                                Rest assured that our cloud hosting infrastructure will ensure your information and
                                data is always safely hosted in the cloud against any failure.
                            </p>
                        </div>
                    </div>
                </div>
...
</section><?php /**PATH C:\Users\Almir Frances\Downloads\tanzahost.in\resources\views/templates/basic/sections/reasons-why-us.blade.php ENDPATH**/ ?>
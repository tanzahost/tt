                            ...
                            <div class="row gy-3 mt-2">
                                ...
                                <div class="col-md-12 {{ $product->payment_type == 1 ? 'd-none' : '' }}">
                                    <div class="form-group">
                                        ...
                                        <select id="billingCycle" name="billing_cycle" class="form-control form--control h-45 form-select">
                                            <option id="monthlyOption" value="monthly">{{ number_format($product->price->monthly, 2) }} USD Monthly</option>
                                            <option id="annuallyOption" value="annually">{{ number_format($product->price->annually, 2) }} USD Annually</option>
                                            <option id="bienniallyOption" value="biennially">{{ number_format($product->price->biennially, 2) }} USD Biennially</option>
                                            <option id="trienniallyOption" value="triennially" selected>{{ number_format($product->price->triennially, 2) }} USD Triennially</option>
                                        </select>
                                    </div>
                                </div>

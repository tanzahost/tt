    ...
    <div class="plan__container" data-js-plan>
        <div class="plan__header plan__header--empty">
            <p data-plan-header-text-top>Did you know that you get a <a href="{{ route('pricing') }}#"
                    ...
                    class="text-bold">free domain reseller</a> with any of these plans?</p>
        ...
        <div class="mobile-slider swiper-container" data-js-plan-slider>
            <div class="plan__wrapper swiper-wrapper plan-wrapper"
                ...
                <div class="plan__header  swiper-slide">
                    <h3 class="plan__title h5">Starter</h3>
                    <div class="pricing">
                        <div class="pricing__price">
                            <h3 class="pricing__amount">$5.99</h3>
                    ...
                    <a href="/reseller-hosting/starter/9"
                ...
                <div class="plan__header  swiper-slide">
                    ...
                    <div class="pricing">
                        <div class="pricing__price">
                            <h3 class="pricing__amount">$8.99</h3>
                            <div class="pricing__period p-4">/mo</div>
                        </div>
                        <div class="pricing__discount" data-toggle='lu-modal'
                            data-target="#modal-discount">
                    ...
                    <a href="/reseller-hosting/business/10"
                        class="btn btn--secondary btn--min-width-md">
                        <span class="btn__text">Get Started Now</span>
                    </a>
                </div>
                <div class="plan__header  swiper-slide">
                    <h3 class="plan__title h5">Pro</h3>
                    <div class="pricing">
                        <div class="pricing__price">
                            <h3 class="pricing__amount">$15.99</h3>
                            <div class="pricing__period p-4">/mo</div>
                        </div>
                        <div class="pricing__discount" data-toggle='lu-modal'
                            data-target="#modal-discount">
                    ...
                    <a href="/reseller-hosting/pro/11"
                        class="btn btn--secondary btn--min-width-md">
                        <span class="btn__text">Get Started Now</span>
                    </a>
                </div>
        ...
        <div class="plan plan--pricing js-plan has-shadow" id="plan1">
            <div class="plan__column plan__column--empty">
                <div class="plan__body">
                    <div class="plan__cell">Website Hosted
                        <label class="label label--tooltip">
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>Number of domains with their own web sites, email
                                    accounts and DNS records that
                                    you may host under your cPanel account.</span>
                            </div>
                        </label>
                    </div>
                    <div class="plan__cell">NVME Disk Space <label
                    ...
                    <div class="plan__cell">cPanel Accounts <label
                            class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>You can create different control panel accounts with
                                    their own settings and
                                    package limits.</span>
                            </div>
                        </label></div>
                    <div class="plan__cell">Inodes per cPanel Account <label
                            class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>Each inode usually equals one file, folder or any other
                                    Unix object in a file system. The number of inodes in your
                                    account equals the number of files and folders you have on
                                    it.</span>
                            </div>
                        </label></div>
                    <div class="plan__cell">Free domain registration <label
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>Order an annual Reseller hosting plan today and register
                                    a brand new domain name,
                                    free of charge for one year. After the first year, the
                                    domain will renew at the regular rate. This offer covers
                    ...
                    <div class="plan__cell">Free SSL Certificates
                        <label class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                    ...
                    <div class="plan__cell">24/7 Support <label class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                                    <path
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <strong>Storage Optimised</strong>
                                <span>More disk space, less cPanel accounts.</span>
                            </div>
                        </label></div>
                    <div class="plan__cell">Softaculous 1-Click Install <label
                            class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                    ...
                    <div class="plan__cell">Domain Reseller Account </div>
                    <div class="plan__cell">Private Nameservers</div>
                    <div class="plan__cell">Brandable cPanel</div>
                    <div class="plan__cell">White Label Option</div>
                    <div class="plan__cell">Free WHM
                        <label class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>WHM allows you to fully manage cPanel accounts of your
                                    customers.</span>
                            </div>
                        </label>
                    </div>
            ...
            <div class="mobile-slider swiper-container" data-js-plan-slider>
                <div class="swiper-wrapper plan-wrapper"
                    data-slide-width='[231,231,231,200,200]'>
...
<div class="list-group list-group--collapse" id="compare-packages-collapse-rh">
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-rh-1" aria-expanded="false"
            aria-controls="compare-packages-rh-1">
        ...
        <div class="list-group__content collapse" id="compare-packages-rh-1">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan2-rh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            <div class="plan__cell">Uptime Guarantee
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Reliable Cloud Platform
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Solid State Storage
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Imunify360 Security
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Advanced Firewall
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Web Application Firewall
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Malware Detection
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Rebootless Secure Kernel
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">CloudLinux OS
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Account Isolation
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Proactive Server Monitoring
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
    ...
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-rh-2" aria-expanded="false"
            aria-controls="compare-packages-rh-2">
        ...
        <div class="list-group__content collapse" id="compare-packages-rh-2">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan3-rh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            <div class="plan__cell">LiteSpeed Cache<label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>With advanced cache-management tools and
                                            ...
                                            Cache is an all-in-one site acceleration
                                            solution.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">HTTP/3</div>
                            <div class="plan__cell">Free CloudFlare CDN
                                <label class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                            ...
                            <div class="plan__cell">Multiple Server Locations<label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Host your website close to its visitors for the
                                            best possible latency and faster page load times.
                                            We offer servers in Dallas, London, Sydney,
                                            Frankfurt, Bucharest, Singapore, and Mumbai.</span>
                                    </div>
                                </label></div>
                            ...
                            <div class="plan__cell">Memcached</div>
                            <div class="plan__cell">Cores per cPanel</div>
                            <div class="plan__cell">Memory Per cPanel User</div>
    ...
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-rh-3" aria-expanded="false">
        ...
        <div class="list-group__content collapse" id="compare-packages-rh-3">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan4-rh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            ...
                            <div class="plan__cell">Catch-all Email<label
                                    class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Allows you to receive all emails that are sent to
                                            an address that does not
                                            exist to the default email address created in your
                                            cPanel.</span>
                                    </div>
                                </label></div>
    ...
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-rh-4" aria-expanded="false">
        ...
        <div class="list-group__content collapse" id="compare-packages-rh-4">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan5-rh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">

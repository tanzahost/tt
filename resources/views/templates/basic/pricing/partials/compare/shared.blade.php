        ...
        <div class="mobile-slider swiper-container" data-js-plan-slider>
            <div class="plan__wrapper swiper-wrapper plan-wrapper"
                ...
                <div class="plan__header  swiper-slide">
                    <h3 class="plan__title h5">Basic</h3>
                    <div class="pricing">
                        <div class="pricing__price">
                            <h3 class="pricing__amount">$1.99</h3>
                            <div class="pricing__period p-4">/mo</div>
                        </div>
                        <div class="pricing__discount" data-toggle='lu-modal'
                            data-target="#modal-discount">
                            {{-- <div class="pricing__old p-4">$5.99</div> --}}
                            <div class="pricing__save p-4">Now 85% Off!</div>
                ...
                <div class="plan__header  swiper-slide">
                    ...
                    <div class="pricing">
                        ...
                        <div class="pricing__discount" data-toggle='lu-modal'
                            data-target="#modal-discount">
                            {{-- <div class="pricing__old p-4">$7.99</div> --}}
                            <div class="pricing__save p-4">Now 75% Off!</div>
                            <div class="pricing__help-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_helpicon123)">
                    ...
                    <a href="/shared-hosting/premium/4"
                        class="btn btn--secondary btn--min-width-md">
                        <span class="btn__text">Get Started Now</span>
                    </a>
                </div>
                <div class="plan__header  swiper-slide">
                    <h3 class="plan__title h5">Business</h3>
                    <div class="pricing">
                        <div class="pricing__price">
                        ...
                        <div class="pricing__discount" data-toggle='lu-modal'
                            data-target="#modal-discount">
                            {{-- <div class="pricing__old p-4">$10.99</div> --}}
                    ...
                    <a href="/shared-hosting/business/5"
                        class="btn btn--secondary btn--min-width-md">
                        <span class="btn__text">Get Started Now</span>
                    </a>
                </div>
...
<div class="section__main-wrapper" data-js-plan-container>
    <div class="section__main-plan" data-js-plan>
        <div class="plan plan--pricing js-plan has-shadow" id="plan1-wh">
            <div class="plan__column plan__column--empty">
                <div class="plan__body">
                    <div class="plan__cell">Websites Hosted</div>
                    <div class="plan__cell">NVME Disk Space
                        <label class="label label--tooltip">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_helpicon123)">
                                    <path
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>All your files are stored exclusively on high-performance
                                    solid-state
                                    drives. This gives you up to 300% better performance than
                                    traditional hard
                                    drives.</span>
                            </div>
                        </label></div>
                    <div class="plan__cell">Bandwidth</div>
                    <div class="plan__cell">Addon Domains</div>
                    <div class="plan__cell">Subdomains</div>
                    ...
                    <div class="plan__cell">Free domain registration<label
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>Order a Web hosting plan today and register a brand new
                                    domain name, free
                                    of charge for one year. After the first year, the domain
                                    will renew at the regular rate. This offer covers the most
                                    popular domain
                                    extensions.</span>
                            </div>
                        </label></div>
                    ...
                    <div class="plan__cell">Inodes <label class="label label--tooltip">
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>Each inode usually equals one file, folder, email or any
                                    other Unix object
                                    in a file system. The number of inodes on your account
                                    equals the number of
                                    files and folders you have on it.</span>
                            </div>
                        </label></div>
                    <div class="plan__cell">Free SSL Certificates <label
                            ...
                            <div class="tooltip tooltip--big tooltip--big-right">
                                <span>We provide free Lets Encrypt SSL certificates to protect
                                    your site with
                                    HTTPS — encrypting traffic and boosting SEO with
                                    Google.</span>
                            </div>
                        </label></div>
                    <div class="plan__cell">Immediate Account Activation</div>
                    <div class="plan__cell">24/7 Support</div>
                ...
                <div class="swiper-wrapper plan-wrapper"
                    ...
                    <div class="swiper-slide">
                        <div class="plan__column">
                            <div class="plan__body">
                                ...
                                <div class="plan__cell">3 Days</div>
                    ...
                    <div class="swiper-slide">
                        <div class="plan__column">
                            <div class="plan__body">
                                <div class="plan__cell">1 Website</div>
                                <div class="plan__cell">50 GB</div>
                                <div class="plan__cell">Unlimited</div>
                                <div class="plan__cell"><i><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18 6L6 18" stroke="#B7B7B7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M6 6L18 18" stroke="#B7B7B7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="plan__cell">7 Days</div>
...
<div class="list-group list-group--collapse" id="compare-packages-collapse-wh">
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-wh-1" aria-expanded="false"
            aria-controls="compare-packages-wh-1">
        ...
        <div class="list-group__content collapse" id="compare-packages-wh-1">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan2-wh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            <div class="plan__cell">Uptime Guarantee <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>You can rely on us because we hate downtime as
                                            much as you do and
                                            we guarantee that our servers will be online with
                                            the highest
                                            possible uptime.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Reliable Cloud Platform <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Our cloud hosting infrastructure keeps your data
                                            safe. By
                                            distributing server data across redundant servers,
                                            information
                                            hosted in the cloud is protected against any
                                            failure.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Web Application Firewall <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>The firewall tightly integrates with mod_security
                                            ...
                                            In combination
                                            with WAF, we can stop the majority of web
                                            application attacks even
                                            before they start.</span>
                                    </div>
                                </label> </div>
                            <div class="plan__cell">Imunify360 Proactive Defense <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Imunify360 is a next-generation all-in-one
                                            ...
                                            uses herd immunity and the unique, proactive
                                            approach to provide
                                            total protection against known and unknown
                                            attacks.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Advanced Firewall Protection <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Advanced firewall protection that uses herd
                                            immunity and
                                            artificial intelligence to detect new threats and
                                            protect the
                                            servers. The firewall is capable of defending
                                            against brute force
                                            attacks, DoS attacks, and port scans.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Malware Detection <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Imunify360 automatically scans file systems for
                                            malware injection
                                            and quarantines infected files.</span>
                                    </div>
                                </label></div>
                            ...
                            <div class="plan__cell">Rebootless Secure Kernel <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Rebootless Secure Kernel powered by KernelCare is
                                            a component that
                                            keeps your server secure by automatically patching
                                            kernels without
                                            having to reboot the server. It checks for new
                                            patches every four
                                            hours and automatically applies them to the server
                                            without any
                                            service disruption.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">CloudLinux OS <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>CloudLinux OS is the leading platform for
                                            ...
                                            isolating each
                                            tenant and giving them allocated server resources.
                                            This creates an
                                            environment that feels more like a virtual server
                                            than a shared
                                            hosting account.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Account Isolation <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>CageFS isolate tenants in "cages" to increase
                                            security. Users only
                                            have access to safe files and their own processes,
                                            and cannot see
                                            other users on the server.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Proactive Server Monitoring <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>We keep a close eye on your server since we react
                                            proactively to
                                            any attacks or problems towards your business. You
                                            can sleep well at
                                            night, knowing that your server stays safe and
                                            secure and your
                                            websites stay online.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">24/7 Network Monitoring <label
                                    class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
    ...
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-wh-2" aria-expanded="false"
            aria-controls="compare-packages-wh-2">
        ...
        <div class="list-group__content collapse" id="compare-packages-wh-2">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan3-wh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            <div class="plan__cell">LiteSpeed Cache <label
                                    class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>With advanced cache-management tools and
                                            ...
                                            LiteSpeed Cache is an all-in-one site acceleration
                                            solution.</span>
                                    </div>
                                </label></div>
                            ...
                            <div class="plan__cell">Free CloudFlare CDN <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>We have partnered with Cloudflare to offer a free
                                            CDN service that
                                            will make your website load fast no matter where
                                            your visitors are
                                            located.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Multiple Server Locations <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Host your website close to its visitors for the
                                            best possible
                                            latency and faster page load times. We offer
                                            servers in Dallas,
                                            Frankfurt, London, Singapore, and Bucharest.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">NVMe Storage <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Enterprise-grade NVMe drives that ensure up to
                                            300% faster access
                                            to your files and databases compared to other
                                            hosting providers
                                            using non-NVMe drives.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">APC/OPCache</div>
                            <div class="plan__cell">Memcached <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Memcached increases the speed of your MySQL
                                            databases by keeping
                                            your most important data in memory for quicker
                                            retrieval.</span>
                                    </div>
                                </label></div>
    ...
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-wh-3" aria-expanded="false">
        ...
        <div class="list-group__content collapse" id="compare-packages-wh-3">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan4-wh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            <div class="plan__cell">Email Accounts </div>
                            <div class="plan__cell">Mailbox Storage</div>
                            <div class="plan__cell">Email Attachment Size</div>
                            <div class="plan__cell">Email Forwarders</div>
                            <div class="plan__cell">Email Aliases</div>
                            <div class="plan__cell">Webmail <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Webmail allows you to access your email accounts
                                            through any
                                            browser. You can use RoundCube as the webmail
                                            client.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">IMAP/POP3/SMTP</div>
                            <div class="plan__cell">Mail Client Setup <label
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Always have your latest emails and contacts at
                                            your fingertips.
                                            Our professional email service work with Outlook,
                                            Apple Mail and
                                            other known email apps to keep all your devices up
                                            to date and in
                                            sync – from your laptop to your smartphone to
                                            tablet.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">MailChannels <label
                                    class="label label--tooltip">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_helpicon123)">
                                    ...
                                    <div class="tooltip tooltip--big tooltip--big-right">
                                        <span>Never worry about Email blacklisting again! We’ve
                                            ...
                                            to the Inbox of
                                            your recipients.</span>
                                    </div>
                                </label></div>
                            <div class="plan__cell">Catch-all Email</div>
                            <div class="plan__cell">SPF and DKIM Support </div>
                            ...
                            <div class="swiper-slide">
                                <div class="plan__column">
                                    <div class="plan__body">
                                        ...
                                        <div class="plan__cell">50 MB</div>
                                        <div class="plan__cell"><i><svg width="24" height="25"
                                                    viewBox="0 0 24 25" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#check1234532clip0)">
    ...
    <div class="list-group__item" data-js-plan-container>
        <div class="list-group__top top" data-toggle="lu-collapse"
            data-target="#compare-packages-wh-4" aria-expanded="false">
        ...
        <div class="list-group__content collapse" id="compare-packages-wh-4">
            <div class="list-group__content-inner">
                <div class="plan plan--pricing js-plan has-shadow" id="plan5-wh" data-js-plan>
                    <div class="plan__column plan__column--empty">
                        <div class="plan__body">
                            ...
                            <div class="plan__cell">NodeJS Support</div>
                            <div class="plan__cell">Python Support</div>
                            <div class="plan__cell">Bash Support</div>
                            <div class="plan__cell">Perl Support</div>
                            <div class="plan__cell">Laravel</div>
                            <div class="plan__cell">Symfony</div>

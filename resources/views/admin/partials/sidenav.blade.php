                    ...
                    @permit('admin.frontend.sections')
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" class="{{menuActive('admin.frontend.sections*',3)}}">
                                ...
                                <span class="menu-title">@lang('Pages Settings')</span>
                            </a>
                            <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                                <ul>
                                    <li class="sidebar-menu-item  {{menuActive(['admin.banners.index'])}} ">
                                        <a href="{{ route('admin.banners.index') }}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Hero Banners</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  {{menuActive(['admin.features.index'])}} ">
                                        <a href="{{ route('admin.features.index') }}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Page Features</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  {{menuActive(['admin.reasons.index'])}} ">
                                        <a href="{{ route('admin.reasons.index') }}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Page reasons</span>
                                        </a>
                                    </li>

                                    <li class="sidebar-menu-item  {{menuActive(['admin.faqs.index'])}} ">
                                        <a href="{{ route('admin.faqs.index') }}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Page faqs</span>
                                        </a>
                                    </li>
                                    @php

                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        @permit('admin.check.slug')
                            <code class="addUrl">{{ route('home') }}/<span class="text--primary"></span></code>
                        @endpermit
                    </div>
                    <div class="form-group">
            ...
            <form class="form-horizontal" method="post" action="{{ route('admin.service.category.update') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        @permit('admin.check.slug')
                            <code class="editUrl">{{ route('home') }}/<span class="text--primary"></span></code>
                        @endpermit
                    </div>
                    <div class="form-group">
                        <label>@lang('SVG Code')</label>
    ...
    <script>
        (function($){
            ...
            $('.editBtn').on('click', function () {
                ...
                modal.find('input[name=price]').val(record.price);

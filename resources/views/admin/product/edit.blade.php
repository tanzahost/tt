            ...
            <form class="form-horizontal" method="post" action="{{ route('admin.product.update') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                            ...
                            <div class="input--group has_append">
                                ...
                                @permit('admin.check.slug')
                                    <code class="slugUrl w-100 mt-2">
                                        {{ route('home') }}<span class="categorySlug text--primary">{{ $product->serviceCategory->slug }}</span>/<span class="productSlug text--primary">{{ $product->slug }}</span><span class="text--primary">/{{ $product->id }}</span>
                                    </code>
                                @endpermit
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <label>@lang('Essential features')</label>
                            <div class="input--group has_append">
                                <textarea name="features" class="form-control" rows="7">{{ $product->features }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <label>@lang('Pro features')</label>
                            <div class="input--group has_append">
                                <textarea name="pro" class="form-control" rows="7">{{ $product->pro }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <label>@lang('Turbo features')</label>
                            <div class="input--group has_append">
                                <textarea name="turbo" class="form-control" rows="7">{{ $product->turbo }}</textarea>
                            </div>
                        </div>
